...
└── wcd-originals/          the vendor lab page, for reference
```

There are no notebooks and no `exercises/` — this day is scripts you paste and
a project you upload, so nothing here is generated by anything.
